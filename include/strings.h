...
extern const u8 gText_TurnExpShareOn[];
extern const u8 gText_TurnExpShareOff[];
...
extern const u8 gCreditsString_Zunawe_kattnip_pret[];
...
extern const u8 gText_MenuGoHome[];
...
extern const u8 gStartMenuDesc_GoHome[];
...
extern const u8 gText_3000Coins_60000[];
extern const u8 gText_5000Coins_100000[];
extern const u8 gText_100Coins_200[];
extern const u8 gText_500Coins_1000[];
extern const u8 gText_1500Coins_3000[];
extern const u8 gText_3000Coins_6000[];
extern const u8 gText_5000Coins_10000[];
extern const u8 gText_Excellent[];
...
// option menu
extern const u8 gText_GeneralOptions[];
extern const u8 gText_BattleOptions[];
extern const u8 gText_SoundOptions[];
extern const u8 gText_QOLOptions[];
...
extern const u8 gText_ExperienceDistribution[];
extern const u8 gText_Sound[];
extern const u8 gText_LowHPBeep[];
extern const u8 gText_SkipFanfares[];
extern const u8 gText_BikeMusic[];
extern const u8 gText_SurfMusic[];
extern const u8 gText_GuaranteedCatch[];
extern const u8 gText_GuaranteedRun[];
extern const u8 gText_EncounterRates[];
extern const u8 gText_EncounterMode[];
extern const u8 gText_BlindTrainers[];
extern const u8 gText_SkipNicknames[];
extern const u8 gText_ItemMessages[];
...
extern const u8 gText_Percent[];
extern const u8 gText_BattleSceneOn[];
extern const u8 gText_BattleSceneOff[];
extern const u8 gText_BattleStyleShift[];
extern const u8 gText_BattleStyleSet[];
extern const u8 gText_ExperienceDistributionGen3[];
extern const u8 gText_ExperienceDistributionGen6[];
extern const u8 gText_ExperienceDistributionGen8[];
extern const u8 gText_TurboA[];
extern const u8 gText_TurboB[];
extern const u8 gText_TurboAB[];
extern const u8 gText_SoundMono[];
extern const u8 gText_SoundStereo[];
extern const u8 gText_EncounterRatesVanilla[];
extern const u8 gText_EncounterRatesNormalized[];
extern const u8 gText_EncounterModeRandom[];
extern const u8 gText_EncounterModeBoost[];
extern const u8 gText_EncounterModeRotate[];
extern const u8 gText_ItemMessagesProgression[];
extern const u8 gText_ItemMessagesAll[];
extern const u8 gText_ItemMessagesNone[];
extern const u8 gText_OptionPage1[];
extern const u8 gText_OptionPage2[];
extern const u8 gText_OptionPage3[];
extern const u8 gText_OptionPage4[];
...
extern const u8 gText_ShopLeave[];
extern const u8 gText_AnythingElseICanHelp[];
extern const u8 gText_AnythingElseToDo[];
extern const u8 gText_QuitShopping[];
extern const u8 gText_PokedollarVar1[];
extern const u8 gText_NoPokedollarVar1[];
extern const u8 gText_SoldOut[];
extern const u8 gText_NA[];
extern const u8 gText_YouDontHaveMoney[];
extern const u8 gText_YouDontHaveCoins[];
extern const u8 gText_Var1CertainlyHowMany[];
extern const u8 gText_InBagVar1[];
extern const u8 gText_Var1AndYouWantedVar2[];
extern const u8 gText_Var1AndYouWantedVar2Coins[];
extern const u8 gText_HereYouGoThankYou[];
extern const u8 gText_NoMoreRoomForThis[];
extern const u8 gText_SorryWereOutOfThis[];
extern const u8 gText_SorryDontSellYet[];
...
extern const u8 gText_NumericalModeDexsanity[];
