...
extern const u8 gText_ExperienceNone[];
extern const u8 gText_ExperienceHalf[];
extern const u8 gText_ExperienceNormal[];
extern const u8 gText_ExperienceDouble[];
extern const u8 gText_ExperienceTriple[];
extern const u8 gText_ExperienceQuadruple[];
extern const u8 gText_ExperienceCustom[];
