...
#define FLAG_DEFEATED_MEWTWO                             0x305
#define FLAG_DEFEATED_MOLTRES                            0x306
#define FLAG_DEFEATED_ARTICUNO                           0x307
#define FLAG_DEFEATED_ZAPDOS                             0x308
#define FLAG_DEFEATED_LUGIA                              0x309
#define FLAG_DEFEATED_HO_OH                              0x30A
#define FLAG_DEFEATED_DEOXYS                             0x30B
#define FLAG_DEFEATED_ENTEI                              0x30C
#define FLAG_DEFEATED_RAIKOU                             0x30D
#define FLAG_DEFEATED_SUICUNE                            0x30E
#define FLAG_DEFEATED_MEW                                0x30F
#define FLAG_DEFEATED_CELEBI                             0x310
#define FLAG_DEFEATED_LATIAS_LATIOS                      0x311
#define FLAG_MEWTWO_IS_RECOVERING                        0x312
#define FLAG_MOLTRES_IS_RECOVERING                       0x313
#define FLAG_ARTICUNO_IS_RECOVERING                      0x314
#define FLAG_ZAPDOS_IS_RECOVERING                        0x315
#define FLAG_LUGIA_IS_RECOVERING                         0x316
#define FLAG_HO_OH_IS_RECOVERING                         0x317
#define FLAG_DEOXYS_IS_RECOVERING                        0x318
#define FLAG_ENTEI_IS_RECOVERING                         0x319
#define FLAG_RAIKOU_IS_RECOVERING                        0x31A
#define FLAG_SUICUNE_IS_RECOVERING                       0x31B
#define FLAG_MEW_IS_RECOVERING                           0x31C
#define FLAG_CELEBI_IS_RECOVERING                        0x31D
#define FLAG_LATIAS_LATIOS_IS_RECOVERING                 0x31E
#define FLAG_POWER_PLANT_ELECTRODE_1_IS_RECOVERING       0x31F
#define FLAG_POWER_PLANT_ELECTRODE_2_IS_RECOVERING       0x320
#define FLAG_ROUTE_12_SNORLAX_IS_RECOVERING              0x321
#define FLAG_ROUTE_16_SNORLAX_IS_RECOVERING              0x322
#define FLAG_BERRY_FOREST_HYPNO_IS_RECOVERING            0x323
#define FLAG_GOT_RUNNING_SHOES                           0x324
