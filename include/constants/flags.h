...
#define FLAG_GOT_2F_CARD_KEY                             0x2AE
#define FLAG_GOT_3F_CARD_KEY                             0x2AF
#define FLAG_GOT_4F_CARD_KEY                             0x2B0
#define FLAG_GOT_5F_CARD_KEY                             0x2B1
#define FLAG_GOT_6F_CARD_KEY                             0x2B2
#define FLAG_GOT_7F_CARD_KEY                             0x2B3
#define FLAG_GOT_8F_CARD_KEY                             0x2B4
#define FLAG_GOT_9F_CARD_KEY                             0x2B5
#define FLAG_GOT_10F_CARD_KEY                            0x2B6
#define FLAG_GOT_11F_CARD_KEY                            0x2B7
...
#define FLAG_CAUGHT_POKEMON_TOWER_MAROWAK                0x304
#define FLAG_CAUGHT_BERRY_FOREST_HYPNO                   0x305
#define FLAG_DEFEATED_MEWTWO                             0x306
#define FLAG_DEFEATED_MOLTRES                            0x307
#define FLAG_DEFEATED_ARTICUNO                           0x308
#define FLAG_DEFEATED_ZAPDOS                             0x309
#define FLAG_DEFEATED_LUGIA                              0x30A
#define FLAG_DEFEATED_HO_OH                              0x30B
#define FLAG_DEFEATED_DEOXYS                             0x30C
#define FLAG_DEFEATED_ENTEI                              0x30D
#define FLAG_DEFEATED_RAIKOU                             0x30E
#define FLAG_DEFEATED_SUICUNE                            0x30F
#define FLAG_DEFEATED_MEW                                0x310
#define FLAG_DEFEATED_CELEBI                             0x311
#define FLAG_DEFEATED_LATIAS_LATIOS                      0x312
#define FLAG_MEWTWO_IS_RECOVERING                        0x313
#define FLAG_MOLTRES_IS_RECOVERING                       0x314
#define FLAG_ARTICUNO_IS_RECOVERING                      0x315
#define FLAG_ZAPDOS_IS_RECOVERING                        0x316
#define FLAG_LUGIA_IS_RECOVERING                         0x317
#define FLAG_HO_OH_IS_RECOVERING                         0x318
#define FLAG_DEOXYS_IS_RECOVERING                        0x319
#define FLAG_ENTEI_IS_RECOVERING                         0x31A
#define FLAG_RAIKOU_IS_RECOVERING                        0x31B
#define FLAG_SUICUNE_IS_RECOVERING                       0x31C
#define FLAG_MEW_IS_RECOVERING                           0x31D
#define FLAG_CELEBI_IS_RECOVERING                        0x31E
#define FLAG_LATIAS_LATIOS_IS_RECOVERING                 0x31F
#define FLAG_POWER_PLANT_ELECTRODE_1_IS_RECOVERING       0x320
#define FLAG_POWER_PLANT_ELECTRODE_2_IS_RECOVERING       0x321
#define FLAG_ROUTE_12_SNORLAX_IS_RECOVERING              0x322
#define FLAG_ROUTE_16_SNORLAX_IS_RECOVERING              0x322
#define FLAG_POKEMON_TOWER_MAROWAK_IS_RECOVERING         0x323
#define FLAG_BERRY_FOREST_HYPNO_IS_RECOVERING            0x324
#define FLAG_GOT_RUNNING_SHOES                           0x325
#define FLAG_GAVE_SCANNER                                0x326
#define FLAG_GOT_DEEP_SEA_SCALE                          0x327
#define FLAG_GOT_DEEP_SEA_TOOTH                          0x328
