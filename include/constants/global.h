...
#define OPTION_EXP_DISTRIBUTION_GEN3 0
#define OPTION_EXP_DISTRIBUTION_GEN6 1
#define OPTION_EXP_DISTRIBUTION_GEN8 2

#define OPTION_ENCOUNTER_MODE_RANDOM 0
#define OPTION_ENCOUNTER_MODE_BOOST 1
#define OPTION_ENCOUNTER_MODE_ROTATE 2
