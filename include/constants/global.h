...
#define OPTIONS_EXPIERENCE_NONE 0
#define OPTIONS_EXPIERENCE_HALF 1
#define OPTIONS_EXPIERENCE_NORMAL 2
#define OPTIONS_EXPIERENCE_DOUBLE 3
#define OPTIONS_EXPIERENCE_TRIPLE 4
#define OPTIONS_EXPIERENCE_QUADRUPLE 5
#define OPTIONS_EXPIERENCE_CUSTOM 6

#define OPTIONS_ITEM_MESSAGES_ALL 0
