...
const std::map<std::string, uint32_t> ARCHIPELAGO_OPTION_OFFSETS = {
	...
	{"cheaperCoins", 0x07},
	{"reusableTms", 0x08},
	{"unlockSeenDexInfo", 0x09},
	{"physicalSpecialSplit", 0x0A},
	{"openViridianCity", 0x0B},
	{"route3Requirement", 0x0C},
	{"openCeruleanCity", 0x0D},
	{"modifyRoute2", 0x0E},
	{"modifyRoute9", 0x0F},
	{"blockTunnels", 0x10},
	{"route12Boulders", 0x11},
	{"modifyRoute10", 0x12},
	{"modifyRoute12", 0x13},
	{"modifyRoute16", 0x14},
	{"openSilphCo", 0x15},
	{"removeSaffronRockets", 0x16},
	{"modifyRoute23", 0x17},
	{"route23Trees", 0x18},
	{"blockPokemonTower", 0x19},
	{"victoryRoadRocks", 0x1A},
	{"earlyFameGossip", 0x1B},
	{"blockSailing", 0x1C},
	{"elevatorsState", 0x1D},
	{"giovanniRequiresGyms", 0x1E},
	{"giovanniRequiredCount", 0x1F},
	{"route22GateRequiresGyms", 0x20},
	{"route22GateRequiredCount", 0x21},
	{"route23GuardRequiresGyms", 0x22},
	{"route23GuardRequiredCount", 0x23},
	{"eliteFourRequiresGyms", 0x24},
	{"eliteFourRequiredCount", 0x25},
	{"eliteFourRematchRequiresGyms", 0x26},
	{"eliteFourRematchRequiredCount", 0x27},
	{"ceruleanCaveRequirement", 0x28},
	{"ceruleanCaveRequiredCount", 0x29},
	{"cinnabarFossilCount", 0x2A},
	{"rematchRequiresGyms", 0x2B},
	{"startingMoney", 0x2C},
	{"itemfinderRequired", 0x30},
	{"flashRequired", 0x31},
	{"fameCheckerRequired", 0x32},
	{"bikeRequiresJumpingShoes", 0x33},
	{"acrobaticBike", 0x34},
	{"oaksAideRequiredCounts", 0x35},
	{"reccuringHiddenItems", 0x3A},
	{"isTrainersanity", 0x3B},
	{"isDexsanity", 0x3C},
	{"extraKeyItems", 0x3D},
	{"kantoOnly", 0x3E},
	{"flyUnlocks", 0x3F},
	...
	{"gymKeys", 0x41},
	{"isShopsanity", 0x42},
	{"removeBadgeRequirement", 0x43},
	{"additionalDarkCaves", 0x44},
	{"passesSplit", 0x45},
	{"cardKeysSplit", 0x46},
	{"teasSplit", 0x47},
	{"startingLocation", 0x48},
	{"startingRespawn", 0x49},
	{"freeFlyId", 0x4A},
	{"townFreeFlyId", 0x4B},
	{"resortGorgeousMon", 0x4C},
	{"introSpecies", 0x4E},
	{"pcItemId", 0x50},
	{"remoteItems", 0x52},
	{"internalEntrancesRandomized", 0x53},
	{"randomized", 0x54},
	{"version", 0x55}
};
