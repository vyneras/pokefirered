...
const u8 gText_AreaEvolution[] = _("{DPAD_LEFTRIGHT}AREA {DPAD_UPDOWN}EVOLUTIONS");
const u8 gText_NextDataCancel[] = _("{A_BUTTON}NEXT DATA {B_BUTTON}CANCEL");
const u8 gText_Next[] = _("{A_BUTTON}NEXT");
const u8 gText_NextDataPreviousData[] = _("{A_BUTTON}NEXT DATA {B_BUTTON}PREVIOUS DATA");
...
const u8 gText_CantEvolve[] = _("CAN'T EVOLVE");
const u8 gText_EncounterArea[] = _("ENCOUNTER AREA");
...
const u8 gText_APItemDescriptionSelf[] = _("An item from another world.\nIt contains your\n");
const u8 gText_APItemDescriptionOther[] = _("An item from another world.\nIt contains ");
const u8 gText_FlyItemDescription[] = _("Unlocks the ability to fly to\n");
...
const u8 gText_TurnExpShareOn[] = _("{PLAYER} turned the EXP. SHARE on.{PAUSE_UNTIL_PRESS}");
const u8 gText_TurnExpShareOff[] = _("{PLAYER} turned the EXP. SHARE off.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ShopLeave[] = _("LEAVE");
...
const u8 gText_Var1AndYouWantedVar2Coins[] = _("{STR_VAR_1}, and you want {STR_VAR_2}.\nThat will be {STR_VAR_3} COINS. Okay?");
...
const u8 gText_SorryDontSellYet[] = _("I'm very sorry, we don't sell\nthis item yet.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_AnythingElseToDo[] = _("Is there anything else you want to\ndo?");
...
const u8 gText_NoPokedollarVar1[] = _("{STR_VAR_1}");
const u8 gText_SoldOut[] = _("SOLD OUT");
const u8 gText_NA[] = _("N/A");
...
const u8 gText_100Coins_2000[] = _("{FONT_SMALL}100 COINS{CLEAR_TO 0x4A}¥2,000");
const u8 gText_500Coins_10000[] = _("{FONT_SMALL}500 COINS{CLEAR_TO 0x45}¥10,000");
const u8 gText_1500Coins_30000[] = _("{FONT_SMALL}1500 COINS{CLEAR_TO 0x45}¥30,000");
const u8 gText_3000Coins_60000[] = _("{FONT_SMALL}3000 COINS{CLEAR_TO 0x45}¥60,000");
const u8 gText_5000Coins_100000[] = _("{FONT_SMALL}5000 COINS{CLEAR_TO 0x40}¥100,000");
const u8 gText_100Coins_200[] = _("{FONT_SMALL}100 COINS{CLEAR_TO 0x54}¥200");
const u8 gText_500Coins_1000[] = _("{FONT_SMALL}500 COINS{CLEAR_TO 0x4A}¥1,000");
const u8 gText_1500Coins_3000[] = _("{FONT_SMALL}1500 COINS{CLEAR_TO 0x4A}¥3,000");
const u8 gText_3000Coins_6000[] = _("{FONT_SMALL}3000 COINS{CLEAR_TO 0x4A}¥6,000");
const u8 gText_5000Coins_10000[] = _("{FONT_SMALL}5000 COINS{CLEAR_TO 0x45}¥10,000");
...
const u8 gText_GeneralOptions[] = _("GENERAL OPTIONS");
const u8 gText_BattleOptions[] = _("BATTLE OPTIONS");
const u8 gText_SoundOptions[] = _("SOUND OPTIONS");
const u8 gText_QOLOptions[] = _("QUALITY OF LIFE OPTIONS");
const u8 gText_TextSpeed[] = _("TEXT SPEED");
const u8 gText_TurboButton[] = _("TURBO BUTTON");
...
const u8 gText_Experience[] = _("EXP MULTIPLIER");
const u8 gText_ExperienceDistribution[] = _("EXP DISTRIBUTION");
const u8 gText_Sound[] = _("SOUND");
const u8 gText_LowHPBeep[] = _("LOW HP BEEP");
const u8 gText_SkipFanfares[] = _("SKIP FANFARES");
const u8 gText_BikeMusic[] = _("BIKE MUSIC");
const u8 gText_SurfMusic[] = _("SURF MUSIC");;
const u8 gText_GuaranteedCatch[] = _("GUARANTEED CATCH");
const u8 gText_GuaranteedRun[] = _("GUARANTEED RUN");
const u8 gText_EncounterRates[] = _("ENCOUNTER RATES");
const u8 gText_EncounterMode[] = _("ENCOUNTER MODE");
const u8 gText_BlindTrainers[] = _("BLIND TRAINERS");
const u8 gText_SkipNicknames[] = _("SKIP NICKNAMES");
const u8 gText_ItemMessages[] = _("ITEM MESSAGES");
...
const u8 gText_ExperienceDistributionGen3[] = _("GEN III");
const u8 gText_ExperienceDistributionGen6[] = _("GEN VI");
const u8 gText_ExperienceDistributionGen8[] = _("GEN VIII");
const u8 gText_TurboA[] = _("A");
const u8 gText_TurboB[] = _("B");
const u8 gText_TurboAB[] = _("A/B");
const u8 gText_SoundMono[] = _("MONO");
const u8 gText_SoundStereo[] = _("STEREO");
const u8 gText_EncounterRatesVanilla[] = _("VANILLA");
const u8 gText_EncounterRatesNormalized[] = _("NORMALIZED");
const u8 gText_EncounterModeRandom[] = _("RANDOM");
const u8 gText_EncounterModeBoost[] = _("BOOST");
const u8 gText_EncounterModeRotate[] = _("ROTATE");
const u8 gText_ItemMessagesProgression[] = _("PROGRESSION");
const u8 gText_ItemMessagesAll[] = _("ALL");
const u8 gText_ItemMessagesNone[] = _("NONE");
const u8 gText_OptionPage1[] = _("{L_BUTTON}QOL {DPAD_UPDOWN}PICK {DPAD_LEFTRIGHT}SWITCH {A_BUTTON}{B_BUTTON}CLOSE {R_BUTTON}BATTLE");
const u8 gText_OptionPage2[] = _("{L_BUTTON}GENERAL {DPAD_UPDOWN}PICK {DPAD_LEFTRIGHT}SWITCH {A_BUTTON}{B_BUTTON}CLOSE {R_BUTTON}SOUND");
const u8 gText_OptionPage3[] = _("{L_BUTTON}BATTLE {DPAD_UPDOWN}PICK {DPAD_LEFTRIGHT}SWITCH {A_BUTTON}{B_BUTTON}CLOSE {R_BUTTON}QOL");
const u8 gText_OptionPage4[] = _("{L_BUTTON}SOUND {DPAD_UPDOWN}PICK {DPAD_LEFTRIGHT}SWITCH {A_BUTTON}{B_BUTTON}CLOSE {R_BUTTON}GENERAL");
...
const u8 gStartMenuDesc_GoHome[] = _("Teleport to your HOME TOWN.");
...
ALIGNED(4) const u8 gCreditsString_Archipelago_Mod[] = _("\n\nArchipelago Mod\n\n\n\n");
ALIGNED(4) const u8 gCreditsString_Vyneras[] = _("\n\n\nVyneras\n\n\n");
ALIGNED(4) const u8 gCreditsString_Archipelago_Special_Thanks[] = _("\nArchipelago Special Thanks\n\n\n\n\n");
ALIGNED(4) const u8 gCreditsString_Zunawe_kattnip_pret[] = _("\n\nZunawe\nkattnip\nThe pret Community\n\n");
