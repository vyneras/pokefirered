...
u16 MapPreview_CreateMapNameWindow(u8 mapsec)
{
    ...
    GetMapName(gStringVar5, mapsec, 0);
    xctr = 104 - GetStringWidth(FONT_NORMAL, gStringVar5, 0);
    AddTextPrinterParameterized4(windowId, FONT_NORMAL, xctr / 2, 2, 0, 0, color/* Access violation */, -1, gStringVar5);
    return windowId;
}
