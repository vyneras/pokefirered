...
const u8 gBattleInterfaceAp_Gfx[] = INCBIN_U8("graphics/battle_interface/healthbox_elements_ap.4bpp");
...
const u8 gMenuInfoApElements_Gfx[] = INCBIN_U8("graphics/interface/menu_info_ap.4bpp");
