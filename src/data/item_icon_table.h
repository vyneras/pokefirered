static const u32 *const sItemIconTable[ITEMS_COUNT + 1][2] =
{
    ...
    // Fly Unlock Items (If ever obtained, should not be added to inventory)
    ...
    [ITEM_PROG_CARD_KEY]  = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    ...
    [ITEM_17F]            = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_180]            = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_181]            = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_182]            = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_183]            = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
    [ITEM_184]            = {gItemIcon_QuestionMark, gItemIconPalette_QuestionMark},
