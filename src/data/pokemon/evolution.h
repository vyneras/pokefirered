const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_POLIWHIRL]  = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_POLIWRATH},
                            {EVO_ITEM, ITEM_KINGS_ROCK_EVO, SPECIES_POLITOED}},
    ...
    [SPECIES_SLOWPOKE]   = {{EVO_LEVEL, 37, SPECIES_SLOWBRO},
                            {EVO_ITEM, ITEM_KINGS_ROCK_EVO, SPECIES_SLOWKING}},
    ...
    [SPECIES_ONIX]       = {{EVO_ITEM, ITEM_METAL_COAT_EVO, SPECIES_STEELIX}},
    ...
    [SPECIES_SCYTHER]    = {{EVO_ITEM, ITEM_METAL_COAT_EVO, SPECIES_SCIZOR}},
    ...
    [SPECIES_CLAMPERL]   = {{EVO_ITEM, ITEM_DEEP_SEA_TOOTH_EVO, SPECIES_HUNTAIL},
                            {EVO_ITEM, ITEM_DEEP_SEA_SCALE_EVO, SPECIES_GOREBYSS}},
