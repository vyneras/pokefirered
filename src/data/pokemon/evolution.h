const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_POLIWHIRL]  = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_POLIWRATH},
                            {EVO_ITEM_HELD, ITEM_LINK_CABLE, SPECIES_POLITOED, ITEM_KINGS_ROCK}},
    ...
    [SPECIES_SLOWPOKE]   = {{EVO_LEVEL, 37, SPECIES_SLOWBRO},
                            {EVO_ITEM_HELD, ITEM_LINK_CABLE, SPECIES_SLOWKING, ITEM_KINGS_ROCK}},
    ...
    [SPECIES_ONIX]       = {{EVO_ITEM_HELD, ITEM_LINK_CABLE, SPECIES_STEELIX, ITEM_METAL_COAT}},
    ...
    [SPECIES_SEADRA]     = {{EVO_ITEM_HELD, ITEM_LINK_CABLE, SPECIES_KINGDRA, ITEM_DRAGON_SCALE}},
    [SPECIES_GOLDEEN]    = {{EVO_LEVEL, 33, SPECIES_SEAKING}},
    [SPECIES_STARYU]     = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_STARMIE}},
    [SPECIES_SCYTHER]    = {{EVO_ITEM_HELD, ITEM_LINK_CABLE, SPECIES_SCIZOR, ITEM_METAL_COAT}},
    ...
    [SPECIES_PORYGON]    = {{EVO_ITEM_HELD, ITEM_LINK_CABLE, SPECIES_PORYGON2, ITEM_UP_GRADE}},
    ...
    [SPECIES_FEEBAS]     = {{EVO_ITEM_HELD, ITEM_LINK_CABLE, SPECIES_MILOTIC, ITEM_HEART_SCALE}},
    ...
    [SPECIES_CLAMPERL]   = {{EVO_ITEM_HELD, ITEM_LINK_CABLE, SPECIES_HUNTAIL, ITEM_DEEP_SEA_TOOTH},
                            {EVO_ITEM_HELD, ITEM_LINK_CABLE, SPECIES_GOREBYSS, ITEM_DEEP_SEA_SCALE}},
