...
static const s8 sFriendshipEventDeltas[][3] =
{
    ...
    [FRIENDSHIP_EVENT_FAINT_SMALL]          = { -5,  -5,  -5 },
    [FRIENDSHIP_EVENT_FAINT_OUTSIDE_BATTLE] = {-25, -25, -50 },
    [FRIENDSHIP_EVENT_FAINT_LARGE]          = {-25, -25, -50 },
};
...
u16 GetEvolutionTargetSpecies(struct Pokemon *mon, u8 type, u16 evolutionItem)
{
    ...
    case EVO_MODE_ITEM_CHECK:
        for (i = 0; i < EVOS_PER_MON; i++)
        {
            ...
            else if (gEvolutionTable[species][i].method == EVO_ITEM_HELD
             && gEvolutionTable[species][i].param == evolutionItem
...
{
    int i = 0;
    return FALSE; // Skip this check so that HMs can be taught over
...
void SetMonPreventsSwitchingString(void)
{
    ...
    BattleStringExpandPlaceholders(gText_PkmnsXPreventsSwitching, gStringVar5);
}
