...
static const struct RematchData sRematches[] = {
   { {TRAINER_YOUNGSTER_BEN, TRAINER_YOUNGSTER_BEN}, MAP(ROUTE3) },
   { {TRAINER_YOUNGSTER_CALVIN, TRAINER_YOUNGSTER_CALVIN}, MAP(ROUTE3) },
   { {TRAINER_BUG_CATCHER_COLTON, TRAINER_BUG_CATCHER_COLTON}, MAP(ROUTE3) },
   { {TRAINER_BUG_CATCHER_GREG, TRAINER_BUG_CATCHER_GREG}, MAP(ROUTE3) },
   { {TRAINER_BUG_CATCHER_JAMES, TRAINER_BUG_CATCHER_JAMES}, MAP(ROUTE3) },
   { {TRAINER_LASS_JANICE, TRAINER_LASS_JANICE}, MAP(ROUTE3) },
   { {TRAINER_LASS_SALLY, TRAINER_LASS_SALLY}, MAP(ROUTE3) },
   { {TRAINER_LASS_ROBIN, TRAINER_LASS_ROBIN}, MAP(ROUTE3) },
   { {TRAINER_LASS_CRISSY, TRAINER_LASS_CRISSY}, MAP(ROUTE4) },
   { {TRAINER_YOUNGSTER_TIMMY, TRAINER_YOUNGSTER_TIMMY}, MAP(ROUTE24) },
   { {TRAINER_BUG_CATCHER_CALE, TRAINER_BUG_CATCHER_CALE}, MAP(ROUTE24) },
   { {TRAINER_LASS_RELI, TRAINER_LASS_RELI}, MAP(ROUTE24) },
   { {TRAINER_LASS_ALI, TRAINER_LASS_ALI}, MAP(ROUTE24) },
   { {TRAINER_CAMPER_SHANE, TRAINER_CAMPER_SHANE}, MAP(ROUTE24) },
   { {TRAINER_CAMPER_ETHAN, TRAINER_CAMPER_ETHAN}, MAP(ROUTE24) },
   { {TRAINER_YOUNGSTER_JOEY, TRAINER_YOUNGSTER_JOEY}, MAP(ROUTE25) },
   { {TRAINER_YOUNGSTER_DAN, TRAINER_YOUNGSTER_DAN}, MAP(ROUTE25) },
   { {TRAINER_YOUNGSTER_CHAD, TRAINER_YOUNGSTER_CHAD}, MAP(ROUTE25) },
   { {TRAINER_PICNICKER_KELSEY, TRAINER_PICNICKER_KELSEY}, MAP(ROUTE25) },
   { {TRAINER_LASS_HALEY, TRAINER_LASS_HALEY}, MAP(ROUTE25) },
   { {TRAINER_HIKER_FRANKLIN, TRAINER_HIKER_FRANKLIN}, MAP(ROUTE25) },
   { {TRAINER_HIKER_NOB, TRAINER_HIKER_NOB}, MAP(ROUTE25) },
   { {TRAINER_HIKER_WAYNE, TRAINER_HIKER_WAYNE}, MAP(ROUTE25) },
   { {TRAINER_CAMPER_FLINT, TRAINER_CAMPER_FLINT}, MAP(ROUTE25) },
   { {TRAINER_BUG_CATCHER_KEIGO, TRAINER_BUG_CATCHER_KEIGO}, MAP(ROUTE6) },
   { {TRAINER_BUG_CATCHER_ELIJAH, TRAINER_BUG_CATCHER_ELIJAH}, MAP(ROUTE6) },
   { {TRAINER_CAMPER_RICKY, TRAINER_CAMPER_RICKY}, MAP(ROUTE6) },
   { {TRAINER_CAMPER_JEFF, TRAINER_CAMPER_JEFF}, MAP(ROUTE6) },
   { {TRAINER_PICNICKER_NANCY, TRAINER_PICNICKER_NANCY}, MAP(ROUTE6) },
   { {TRAINER_PICNICKER_ISABELLE, TRAINER_PICNICKER_ISABELLE}, MAP(ROUTE6) },
   { {TRAINER_YOUNGSTER_EDDIE, TRAINER_YOUNGSTER_EDDIE}, MAP(ROUTE11) },
   { {TRAINER_YOUNGSTER_DILLON, TRAINER_YOUNGSTER_DILLON}, MAP(ROUTE11) },
   { {TRAINER_YOUNGSTER_YASU, TRAINER_YOUNGSTER_YASU}, MAP(ROUTE11) },
   { {TRAINER_YOUNGSTER_DAVE, TRAINER_YOUNGSTER_DAVE}, MAP(ROUTE11) },
   { {TRAINER_ENGINEER_BRAXTON, TRAINER_ENGINEER_BRAXTON}, MAP(ROUTE11) },
   { {TRAINER_ENGINEER_BERNIE, TRAINER_ENGINEER_BERNIE}, MAP(ROUTE11) },
   { {TRAINER_GAMER_HUGO, TRAINER_GAMER_HUGO}, MAP(ROUTE11) },
   { {TRAINER_GAMER_JASPER, TRAINER_GAMER_JASPER}, MAP(ROUTE11) },
   { {TRAINER_GAMER_DIRK, TRAINER_GAMER_DIRK}, MAP(ROUTE11) },
   { {TRAINER_GAMER_DARIAN, TRAINER_GAMER_DARIAN}, MAP(ROUTE11) },
   { {TRAINER_BUG_CATCHER_BRENT, TRAINER_BUG_CATCHER_BRENT}, MAP(ROUTE9) },
   { {TRAINER_BUG_CATCHER_CONNER, TRAINER_BUG_CATCHER_CONNER}, MAP(ROUTE9) },
   { {TRAINER_CAMPER_CHRIS, TRAINER_CAMPER_CHRIS}, MAP(ROUTE9) },
   { {TRAINER_CAMPER_DREW, TRAINER_CAMPER_DREW}, MAP(ROUTE9) },
   { {TRAINER_PICNICKER_ALICIA, TRAINER_PICNICKER_ALICIA}, MAP(ROUTE9) },
   { {TRAINER_PICNICKER_CAITLIN, TRAINER_PICNICKER_CAITLIN}, MAP(ROUTE9) },
   { {TRAINER_HIKER_ALAN, TRAINER_HIKER_ALAN}, MAP(ROUTE9) },
   { {TRAINER_HIKER_BRICE, TRAINER_HIKER_BRICE}, MAP(ROUTE9) },
   { {TRAINER_HIKER_JEREMY, TRAINER_HIKER_JEREMY}, MAP(ROUTE9) },
   { {TRAINER_PICNICKER_HEIDI, TRAINER_PICNICKER_HEIDI}, MAP(ROUTE10) },
   { {TRAINER_PICNICKER_CAROL, TRAINER_PICNICKER_CAROL}, MAP(ROUTE10) },
   { {TRAINER_POKEMANIAC_MARK, TRAINER_POKEMANIAC_MARK}, MAP(ROUTE10) },
   { {TRAINER_POKEMANIAC_HERMAN, TRAINER_POKEMANIAC_HERMAN}, MAP(ROUTE10) },
   { {TRAINER_HIKER_CLARK, TRAINER_HIKER_CLARK}, MAP(ROUTE10) },
   { {TRAINER_HIKER_TRENT, TRAINER_HIKER_TRENT}, MAP(ROUTE10) },
   { {TRAINER_LASS_PAIGE, TRAINER_LASS_PAIGE}, MAP(ROUTE8) },
   { {TRAINER_LASS_ANDREA, TRAINER_LASS_ANDREA}, MAP(ROUTE8) },
   { {TRAINER_LASS_MEGAN, TRAINER_LASS_MEGAN}, MAP(ROUTE8) },
   { {TRAINER_LASS_JULIA, TRAINER_LASS_JULIA}, MAP(ROUTE8) },
   { {TRAINER_SUPER_NERD_AIDAN, TRAINER_SUPER_NERD_AIDAN}, MAP(ROUTE8) },
   { {TRAINER_SUPER_NERD_GLENN, TRAINER_SUPER_NERD_GLENN}, MAP(ROUTE8) },
   { {TRAINER_SUPER_NERD_LESLIE, TRAINER_SUPER_NERD_LESLIE}, MAP(ROUTE8) },
   { {TRAINER_GAMER_STAN, TRAINER_GAMER_STAN}, MAP(ROUTE8) },
   { {TRAINER_GAMER_RICH, TRAINER_GAMER_RICH}, MAP(ROUTE8) },
   { {TRAINER_TWINS_ELI_ANNE, TRAINER_TWINS_ELI_ANNE}, MAP(ROUTE8) },
   { {TRAINER_BIKER_RICARDO, TRAINER_BIKER_RICARDO}, MAP(ROUTE8) },
   { {TRAINER_BIKER_JAREN, TRAINER_BIKER_JAREN}, MAP(ROUTE8) },
   { {TRAINER_FISHERMAN_NED, TRAINER_FISHERMAN_NED}, MAP(ROUTE12) },
   { {TRAINER_FISHERMAN_CHIP, TRAINER_FISHERMAN_CHIP}, MAP(ROUTE12) },
   { {TRAINER_FISHERMAN_HANK, TRAINER_FISHERMAN_HANK}, MAP(ROUTE12) },
   { {TRAINER_FISHERMAN_ELLIOT, TRAINER_FISHERMAN_ELLIOT}, MAP(ROUTE12) },
   { {TRAINER_FISHERMAN_ANDREW, TRAINER_FISHERMAN_ANDREW}, MAP(ROUTE12) },
   { {TRAINER_ROCKER_LUCA, TRAINER_ROCKER_LUCA}, MAP(ROUTE12) },
   { {TRAINER_CAMPER_JUSTIN, TRAINER_CAMPER_JUSTIN}, MAP(ROUTE12) },
   { {TRAINER_YOUNG_COUPLE_GIA_JES, TRAINER_YOUNG_COUPLE_GIA_JES}, MAP(ROUTE12) },
   { {TRAINER_BIKER_JARED, TRAINER_BIKER_JARED}, MAP(ROUTE13) },
   { {TRAINER_BEAUTY_LOLA, TRAINER_BEAUTY_LOLA}, MAP(ROUTE13) },
   { {TRAINER_BEAUTY_SHEILA, TRAINER_BEAUTY_SHEILA}, MAP(ROUTE13) },
   { {TRAINER_BIRD_KEEPER_SEBASTIAN, TRAINER_BIRD_KEEPER_SEBASTIAN}, MAP(ROUTE13) },
   { {TRAINER_BIRD_KEEPER_PERRY, TRAINER_BIRD_KEEPER_PERRY}, MAP(ROUTE13) },
   { {TRAINER_BIRD_KEEPER_ROBERT, TRAINER_BIRD_KEEPER_ROBERT}, MAP(ROUTE13) },
   { {TRAINER_PICNICKER_ALMA, TRAINER_PICNICKER_ALMA}, MAP(ROUTE13) },
   { {TRAINER_PICNICKER_SUSIE, TRAINER_PICNICKER_SUSIE}, MAP(ROUTE13) },
   { {TRAINER_PICNICKER_VALERIE, TRAINER_PICNICKER_VALERIE}, MAP(ROUTE13) },
   { {TRAINER_PICNICKER_GWEN, TRAINER_PICNICKER_GWEN}, MAP(ROUTE13) },
   { {TRAINER_BIKER_MALIK, TRAINER_BIKER_MALIK}, MAP(ROUTE14) },
   { {TRAINER_BIKER_LUKAS, TRAINER_BIKER_LUKAS}, MAP(ROUTE14) },
   { {TRAINER_BIKER_ISAAC, TRAINER_BIKER_ISAAC}, MAP(ROUTE14) },
   { {TRAINER_BIKER_GERALD, TRAINER_BIKER_GERALD}, MAP(ROUTE14) },
   { {TRAINER_BIRD_KEEPER_DONALD, TRAINER_BIRD_KEEPER_DONALD}, MAP(ROUTE14) },
   { {TRAINER_BIRD_KEEPER_BENNY, TRAINER_BIRD_KEEPER_BENNY}, MAP(ROUTE14) },
   { {TRAINER_BIRD_KEEPER_CARTER, TRAINER_BIRD_KEEPER_CARTER}, MAP(ROUTE14) },
   { {TRAINER_BIRD_KEEPER_MITCH, TRAINER_BIRD_KEEPER_MITCH}, MAP(ROUTE14) },
   { {TRAINER_BIRD_KEEPER_BECK, TRAINER_BIRD_KEEPER_BECK}, MAP(ROUTE14) },
   { {TRAINER_BIRD_KEEPER_MARLON, TRAINER_BIRD_KEEPER_MARLON}, MAP(ROUTE14) },
   { {TRAINER_TWINS_KIRI_JAN, TRAINER_TWINS_KIRI_JAN}, MAP(ROUTE14) },
   { {TRAINER_BIKER_ERNEST, TRAINER_BIKER_ERNEST}, MAP(ROUTE15) },
   { {TRAINER_BIKER_ALEX, TRAINER_BIKER_ALEX}, MAP(ROUTE15) },
   { {TRAINER_BEAUTY_GRACE, TRAINER_BEAUTY_GRACE}, MAP(ROUTE15) },
   { {TRAINER_BEAUTY_OLIVIA, TRAINER_BEAUTY_OLIVIA}, MAP(ROUTE15) },
   { {TRAINER_BIRD_KEEPER_EDWIN, TRAINER_BIRD_KEEPER_EDWIN}, MAP(ROUTE15) },
   { {TRAINER_BIRD_KEEPER_CHESTER, TRAINER_BIRD_KEEPER_CHESTER}, MAP(ROUTE15) },
   { {TRAINER_PICNICKER_YAZMIN, TRAINER_PICNICKER_YAZMIN}, MAP(ROUTE15) },
   { {TRAINER_PICNICKER_KINDRA, TRAINER_PICNICKER_KINDRA}, MAP(ROUTE15) },
   { {TRAINER_PICNICKER_BECKY, TRAINER_PICNICKER_BECKY}, MAP(ROUTE15) },
   { {TRAINER_PICNICKER_CELIA, TRAINER_PICNICKER_CELIA}, MAP(ROUTE15) },
   { {TRAINER_CRUSH_KIN_RON_MYA, TRAINER_CRUSH_KIN_RON_MYA}, MAP(ROUTE15) },
   { {TRAINER_BIKER_LAO, TRAINER_BIKER_LAO}, MAP(ROUTE16) },
   { {TRAINER_BIKER_HIDEO, TRAINER_BIKER_HIDEO}, MAP(ROUTE16) },
   { {TRAINER_BIKER_RUBEN, TRAINER_BIKER_RUBEN}, MAP(ROUTE16) },
   { {TRAINER_CUE_BALL_KOJI, TRAINER_CUE_BALL_KOJI}, MAP(ROUTE16) },
   { {TRAINER_CUE_BALL_LUKE, TRAINER_CUE_BALL_LUKE}, MAP(ROUTE16) },
   { {TRAINER_CUE_BALL_CAMRON, TRAINER_CUE_BALL_CAMRON}, MAP(ROUTE16) },
   { {TRAINER_YOUNG_COUPLE_LEA_JED, TRAINER_YOUNG_COUPLE_LEA_JED}, MAP(ROUTE16) },
   { {TRAINER_BIKER_BILLY, TRAINER_BIKER_BILLY}, MAP(ROUTE17) },
   { {TRAINER_BIKER_NIKOLAS, TRAINER_BIKER_NIKOLAS}, MAP(ROUTE17) },
   { {TRAINER_BIKER_JAXON, TRAINER_BIKER_JAXON}, MAP(ROUTE17) },
   { {TRAINER_BIKER_WILLIAM, TRAINER_BIKER_WILLIAM}, MAP(ROUTE17) },
   { {TRAINER_CUE_BALL_RAUL, TRAINER_CUE_BALL_RAUL}, MAP(ROUTE17) },
   { {TRAINER_CUE_BALL_ISAIAH, TRAINER_CUE_BALL_ISAIAH}, MAP(ROUTE17) },
   { {TRAINER_CUE_BALL_ZEEK, TRAINER_CUE_BALL_ZEEK}, MAP(ROUTE17) },
   { {TRAINER_CUE_BALL_JAMAL, TRAINER_CUE_BALL_JAMAL}, MAP(ROUTE17) },
   { {TRAINER_CUE_BALL_COREY, TRAINER_CUE_BALL_COREY}, MAP(ROUTE17) },
   { {TRAINER_BIKER_VIRGIL, TRAINER_BIKER_VIRGIL}, MAP(ROUTE17) },
   { {TRAINER_BIRD_KEEPER_WILTON, TRAINER_BIRD_KEEPER_WILTON}, MAP(ROUTE18) },
   { {TRAINER_BIRD_KEEPER_RAMIRO, TRAINER_BIRD_KEEPER_RAMIRO}, MAP(ROUTE18) },
   { {TRAINER_BIRD_KEEPER_JACOB, TRAINER_BIRD_KEEPER_JACOB}, MAP(ROUTE18) },
   { {TRAINER_SWIMMER_MALE_RICHARD, TRAINER_SWIMMER_MALE_RICHARD}, MAP(ROUTE19) },
   { {TRAINER_SWIMMER_MALE_REECE, TRAINER_SWIMMER_MALE_REECE}, MAP(ROUTE19) },
   { {TRAINER_SWIMMER_MALE_MATTHEW, TRAINER_SWIMMER_MALE_MATTHEW}, MAP(ROUTE19) },
   { {TRAINER_SWIMMER_MALE_DOUGLAS, TRAINER_SWIMMER_MALE_DOUGLAS}, MAP(ROUTE19) },
   { {TRAINER_SWIMMER_MALE_DAVID, TRAINER_SWIMMER_MALE_DAVID}, MAP(ROUTE19) },
   { {TRAINER_SWIMMER_MALE_TONY, TRAINER_SWIMMER_MALE_TONY}, MAP(ROUTE19) },
   { {TRAINER_SWIMMER_MALE_AXLE, TRAINER_SWIMMER_MALE_AXLE}, MAP(ROUTE19) },
   { {TRAINER_SWIMMER_FEMALE_ANYA, TRAINER_SWIMMER_FEMALE_ANYA}, MAP(ROUTE19) },
   { {TRAINER_SWIMMER_FEMALE_ALICE, TRAINER_SWIMMER_FEMALE_ALICE}, MAP(ROUTE19) },
   { {TRAINER_SWIMMER_FEMALE_CONNIE, TRAINER_SWIMMER_FEMALE_CONNIE}, MAP(ROUTE19) },
   { {TRAINER_SIS_AND_BRO_LIA_LUC, TRAINER_SIS_AND_BRO_LIA_LUC}, MAP(ROUTE19) },
   { {TRAINER_SWIMMER_MALE_BARRY, TRAINER_SWIMMER_MALE_BARRY}, MAP(ROUTE20) },
   { {TRAINER_SWIMMER_MALE_DEAN, TRAINER_SWIMMER_MALE_DEAN}, MAP(ROUTE20) },
   { {TRAINER_SWIMMER_MALE_DARRIN, TRAINER_SWIMMER_MALE_DARRIN}, MAP(ROUTE20) },
   { {TRAINER_SWIMMER_FEMALE_TIFFANY, TRAINER_SWIMMER_FEMALE_TIFFANY}, MAP(ROUTE20) },
   { {TRAINER_SWIMMER_FEMALE_NORA, TRAINER_SWIMMER_FEMALE_NORA}, MAP(ROUTE20) },
   { {TRAINER_SWIMMER_FEMALE_MELISSA, TRAINER_SWIMMER_FEMALE_MELISSA}, MAP(ROUTE20) },
   { {TRAINER_SWIMMER_FEMALE_SHIRLEY, TRAINER_SWIMMER_FEMALE_SHIRLEY}, MAP(ROUTE20) },
   { {TRAINER_BIRD_KEEPER_ROGER, TRAINER_BIRD_KEEPER_ROGER}, MAP(ROUTE20) },
   { {TRAINER_PICNICKER_MISSY, TRAINER_PICNICKER_MISSY}, MAP(ROUTE20) },
   { {TRAINER_PICNICKER_IRENE, TRAINER_PICNICKER_IRENE}, MAP(ROUTE20) },
   { {TRAINER_FISHERMAN_RONALD, TRAINER_FISHERMAN_RONALD}, MAP(ROUTE21_NORTH) },
   { {TRAINER_FISHERMAN_CLAUDE, TRAINER_FISHERMAN_CLAUDE}, MAP(ROUTE21_NORTH) },
   { {TRAINER_FISHERMAN_WADE, TRAINER_FISHERMAN_WADE}, MAP(ROUTE21_NORTH) },
   { {TRAINER_FISHERMAN_NOLAN, TRAINER_FISHERMAN_NOLAN}, MAP(ROUTE21_NORTH) },
   { {TRAINER_SWIMMER_MALE_SPENCER, TRAINER_SWIMMER_MALE_SPENCER}, MAP(ROUTE21_NORTH) },
   { {TRAINER_SWIMMER_MALE_JACK, TRAINER_SWIMMER_MALE_JACK}, MAP(ROUTE21_NORTH) },
   { {TRAINER_SWIMMER_MALE_JEROME, TRAINER_SWIMMER_MALE_JEROME}, MAP(ROUTE21_NORTH) },
   { {TRAINER_SWIMMER_MALE_ROLAND, TRAINER_SWIMMER_MALE_ROLAND}, MAP(ROUTE21_NORTH) },
   { {TRAINER_SIS_AND_BRO_LIL_IAN, TRAINER_SIS_AND_BRO_LIL_IAN}, MAP(ROUTE21_NORTH) },
   { {TRAINER_SWIMMER_FEMALE_MARIA, TRAINER_SWIMMER_FEMALE_MARIA}, MAP(ONE_ISLAND_KINDLE_ROAD) },
   { {TRAINER_SWIMMER_FEMALE_ABIGAIL, TRAINER_SWIMMER_FEMALE_ABIGAIL}, MAP(ONE_ISLAND_KINDLE_ROAD) },
   { {TRAINER_SWIMMER_MALE_FINN, TRAINER_SWIMMER_MALE_FINN}, MAP(ONE_ISLAND_KINDLE_ROAD) },
   { {TRAINER_SWIMMER_MALE_GARRETT, TRAINER_SWIMMER_MALE_GARRETT}, MAP(ONE_ISLAND_KINDLE_ROAD) },
   { {TRAINER_FISHERMAN_TOMMY, TRAINER_FISHERMAN_TOMMY}, MAP(ONE_ISLAND_KINDLE_ROAD) },
   { {TRAINER_CRUSH_GIRL_SHARON, TRAINER_CRUSH_GIRL_SHARON}, MAP(ONE_ISLAND_KINDLE_ROAD) },
   { {TRAINER_CRUSH_GIRL_TANYA, TRAINER_CRUSH_GIRL_TANYA}, MAP(ONE_ISLAND_KINDLE_ROAD) },
   { {TRAINER_BLACK_BELT_SHEA, TRAINER_BLACK_BELT_SHEA}, MAP(ONE_ISLAND_KINDLE_ROAD) },
   { {TRAINER_BLACK_BELT_HUGH, TRAINER_BLACK_BELT_HUGH}, MAP(ONE_ISLAND_KINDLE_ROAD) },
   { {TRAINER_CAMPER_BRYCE, TRAINER_CAMPER_BRYCE}, MAP(ONE_ISLAND_KINDLE_ROAD) },
   { {TRAINER_PICNICKER_CLAIRE, TRAINER_PICNICKER_CLAIRE}, MAP(ONE_ISLAND_KINDLE_ROAD) },
   { {TRAINER_CRUSH_KIN_MIK_KIA, TRAINER_CRUSH_KIN_MIK_KIA}, MAP(ONE_ISLAND_KINDLE_ROAD) },
   { {TRAINER_SWIMMER_FEMALE_AMARA, TRAINER_SWIMMER_FEMALE_AMARA}, MAP(ONE_ISLAND_TREASURE_BEACH) },
   { {TRAINER_AROMA_LADY_NIKKI, TRAINER_AROMA_LADY_NIKKI}, MAP(THREE_ISLAND_BOND_BRIDGE) },
   { {TRAINER_AROMA_LADY_VIOLET, TRAINER_AROMA_LADY_VIOLET}, MAP(THREE_ISLAND_BOND_BRIDGE) },
   { {TRAINER_TUBER_AMIRA, TRAINER_TUBER_AMIRA}, MAP(THREE_ISLAND_BOND_BRIDGE) },
   ...
   { {TRAINER_TWINS_JOY_MEG, TRAINER_TWINS_JOY_MEG}, MAP(THREE_ISLAND_BOND_BRIDGE) },
   ...
   { {TRAINER_PAINTER_RAYNA, TRAINER_PAINTER_RAYNA}, MAP(FIVE_ISLAND_RESORT_GORGEOUS) },
   { {TRAINER_LADY_JACKI, TRAINER_LADY_JACKI}, MAP(FIVE_ISLAND_RESORT_GORGEOUS) },
   { {TRAINER_LADY_GILLIAN, TRAINER_LADY_GILLIAN}, MAP(FIVE_ISLAND_RESORT_GORGEOUS) },
   { {TRAINER_YOUNGSTER_DESTIN, TRAINER_YOUNGSTER_DESTIN}, MAP(FIVE_ISLAND_RESORT_GORGEOUS) },
   { {TRAINER_SWIMMER_MALE_TOBY, TRAINER_SWIMMER_MALE_TOBY}, MAP(FIVE_ISLAND_RESORT_GORGEOUS) },
   { {TRAINER_PKMN_BREEDER_ALIZE, TRAINER_PKMN_BREEDER_ALIZE}, MAP(FIVE_ISLAND_WATER_LABYRINTH) },
   { {TRAINER_BIRD_KEEPER_MILO, TRAINER_BIRD_KEEPER_MILO}, MAP(FIVE_ISLAND_MEMORIAL_PILLAR) },
   { {TRAINER_BIRD_KEEPER_CHAZ, TRAINER_BIRD_KEEPER_CHAZ}, MAP(FIVE_ISLAND_MEMORIAL_PILLAR) },
   { {TRAINER_BIRD_KEEPER_HAROLD, TRAINER_BIRD_KEEPER_HAROLD}, MAP(FIVE_ISLAND_MEMORIAL_PILLAR) },
   { {TRAINER_FISHERMAN_TYLOR, TRAINER_FISHERMAN_TYLOR}, MAP(SIX_ISLAND_OUTCAST_ISLAND) },
   { {TRAINER_SWIMMER_MALE_MYMO, TRAINER_SWIMMER_MALE_MYMO}, MAP(SIX_ISLAND_OUTCAST_ISLAND) },
   { {TRAINER_SWIMMER_FEMALE_NICOLE, TRAINER_SWIMMER_FEMALE_NICOLE}, MAP(SIX_ISLAND_OUTCAST_ISLAND) },
   { {TRAINER_SIS_AND_BRO_AVA_GEB, TRAINER_SIS_AND_BRO_AVA_GEB}, MAP(SIX_ISLAND_OUTCAST_ISLAND) },
   { {TRAINER_PSYCHIC_JACLYN, TRAINER_PSYCHIC_JACLYN}, MAP(SIX_ISLAND_GREEN_PATH) },
   { {TRAINER_AROMA_LADY_ROSE, TRAINER_AROMA_LADY_ROSE}, MAP(SIX_ISLAND_WATER_PATH) },
   { {TRAINER_JUGGLER_EDWARD, TRAINER_JUGGLER_EDWARD}, MAP(SIX_ISLAND_WATER_PATH) },
   { {TRAINER_SWIMMER_MALE_SAMIR, TRAINER_SWIMMER_MALE_SAMIR}, MAP(SIX_ISLAND_WATER_PATH) },
   { {TRAINER_SWIMMER_FEMALE_DENISE, TRAINER_SWIMMER_FEMALE_DENISE}, MAP(SIX_ISLAND_WATER_PATH) },
   { {TRAINER_TWINS_MIU_MIA, TRAINER_TWINS_MIU_MIA}, MAP(SIX_ISLAND_WATER_PATH) },
   { {TRAINER_HIKER_EARL, TRAINER_HIKER_EARL}, MAP(SIX_ISLAND_WATER_PATH) },
   { {TRAINER_RUIN_MANIAC_STANLY, TRAINER_RUIN_MANIAC_STANLY}, MAP(SIX_ISLAND_RUIN_VALLEY) },
   { {TRAINER_RUIN_MANIAC_FOSTER, TRAINER_RUIN_MANIAC_FOSTER}, MAP(SIX_ISLAND_RUIN_VALLEY) },
   { {TRAINER_RUIN_MANIAC_LARRY, TRAINER_RUIN_MANIAC_LARRY}, MAP(SIX_ISLAND_RUIN_VALLEY) },
   { {TRAINER_HIKER_DARYL, TRAINER_HIKER_DARYL}, MAP(SIX_ISLAND_RUIN_VALLEY) },
   { {TRAINER_POKEMANIAC_HECTOR, TRAINER_POKEMANIAC_HECTOR}, MAP(SIX_ISLAND_RUIN_VALLEY) },
   { {TRAINER_PSYCHIC_DARIO, TRAINER_PSYCHIC_DARIO}, MAP(SEVEN_ISLAND_TRAINER_TOWER) },
   { {TRAINER_PSYCHIC_RODETTE, TRAINER_PSYCHIC_RODETTE}, MAP(SEVEN_ISLAND_TRAINER_TOWER) },
   { {TRAINER_AROMA_LADY_MIAH, TRAINER_AROMA_LADY_MIAH}, MAP(SEVEN_ISLAND_SEVAULT_CANYON_ENTRANCE) },
   { {TRAINER_YOUNG_COUPLE_EVE_JON, TRAINER_YOUNG_COUPLE_EVE_JON}, MAP(SEVEN_ISLAND_SEVAULT_CANYON_ENTRANCE) },
   { {TRAINER_JUGGLER_MASON, TRAINER_JUGGLER_MASON}, MAP(SEVEN_ISLAND_SEVAULT_CANYON_ENTRANCE) },
   { {TRAINER_PKMN_RANGER_NICOLAS, TRAINER_PKMN_RANGER_NICOLAS}, MAP(SEVEN_ISLAND_SEVAULT_CANYON_ENTRANCE) },
   { {TRAINER_PKMN_RANGER_MADELINE, TRAINER_PKMN_RANGER_MADELINE}, MAP(SEVEN_ISLAND_SEVAULT_CANYON_ENTRANCE) },
   { {TRAINER_CRUSH_GIRL_CYNDY, TRAINER_CRUSH_GIRL_CYNDY}, MAP(SEVEN_ISLAND_SEVAULT_CANYON) },
   { {TRAINER_TAMER_EVAN, TRAINER_TAMER_EVAN}, MAP(SEVEN_ISLAND_SEVAULT_CANYON) },
   { {TRAINER_PKMN_RANGER_JACKSON, TRAINER_PKMN_RANGER_JACKSON}, MAP(SEVEN_ISLAND_SEVAULT_CANYON) },
   { {TRAINER_PKMN_RANGER_KATELYN, TRAINER_PKMN_RANGER_KATELYN}, MAP(SEVEN_ISLAND_SEVAULT_CANYON) },
   { {TRAINER_COOLTRAINER_LEROY, TRAINER_COOLTRAINER_LEROY}, MAP(SEVEN_ISLAND_SEVAULT_CANYON) },
   { {TRAINER_COOLTRAINER_MICHELLE, TRAINER_COOLTRAINER_MICHELLE}, MAP(SEVEN_ISLAND_SEVAULT_CANYON) },
   { {TRAINER_COOL_COUPLE_LEX_NYA, TRAINER_COOL_COUPLE_LEX_NYA}, MAP(SEVEN_ISLAND_SEVAULT_CANYON) },
   { {TRAINER_RUIN_MANIAC_BRANDON, TRAINER_RUIN_MANIAC_BRANDON}, MAP(SEVEN_ISLAND_TANOBY_RUINS) },
   { {TRAINER_RUIN_MANIAC_BENJAMIN, TRAINER_RUIN_MANIAC_BENJAMIN}, MAP(SEVEN_ISLAND_TANOBY_RUINS) },
   { {TRAINER_PAINTER_EDNA, TRAINER_PAINTER_EDNA}, MAP(SEVEN_ISLAND_TANOBY_RUINS) },
   { {TRAINER_GENTLEMAN_CLIFFORD, TRAINER_GENTLEMAN_CLIFFORD}, MAP(SEVEN_ISLAND_TANOBY_RUINS) },
};
