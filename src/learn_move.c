...
static void StringExpandPlaceholdersAndPrintTextOnWindow7Color2(const u8 *str)
{
    ...
    PrintTextOnWindow(7, gStringVar5, 0, 2, GetTextSpeedSetting(), 2);
}
...
static void PrintTeachWhichMoveToStrVar1(bool8 onInit)
{
    if (!onInit)
    {
        StringExpandPlaceholders(gStringVar5, gText_TeachWhichMoveToMon);
        PrintTextOnWindow(7, gStringVar5, 0, 2, 0, 2);
        PutWindowTilemap(7);
